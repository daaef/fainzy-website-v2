...
export default function AboutPage() {
    ...
    return (
        <>
            <header>
                <section
                    className="relative min-h-[60vh] md:min-h-[70vh] lg:min-h-[802px] flex items-center justify-center overflow-hidden relative">
                    <Image className="absolute w-full h-full object-cover" src={AboutBanner} height={1000} width={1000}
                           alt="about banner"/>
                    {/* Background Image Placeholder */}
                    <div className="absolute inset-0">
                        <div className="absolute inset-0 opacity-20">
                            <div
                                className="w-full h-full bg-[repeating-linear-gradient(90deg,rgba(255,255,255,0.03)_0px,rgba(255,255,255,0.03)_1px,transparent_1px,transparent_96px),repeating-linear-gradient(0deg,rgba(255,255,255,0.03)_0px,rgba(255,255,255,0.03)_1px,transparent_1px,transparent_96px)]"/>
                        </div>
                    </div>

                    {/* Gradient Overlay */}
                    <div
                        className="absolute inset-0 bg-gradient-to-b from-[rgba(10,10,11,0.3)] via-[rgba(10,10,11,0.5)] to-[rgba(10,10,11,0.7)]"/>
            ...
            <main>
                ...
                <section className="py-12 md:py-20 lg:py-[100px]">
                    <div className="container">
                        <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-12 lg:gap-16">
                            ...
                            >
                                <div
                                    className="relative w-full h-[300px] sm:h-[400px] lg:h-[500px] rounded-[16px] overflow-hidden shadow-xl">
                                    <Image src={Founded}
                                           height={1000}
                                           width={1000}
                            ...
                            >
                                ...
                                >
                                    ...
                                    intersection of cutting-edge technology and human ingenuity holds the key to solving
                                ...
                                >
                                    ...
                                    create intelligent systems that enhance productivity, improve safety, and unlock new
                                ...
                                <motion.p
                                    ...
                                    className="text-neutral-400 text-sm sm:text-base leading-relaxed"
                                >
                                    From autonomous robotics to advanced AI solutions, we're committed to building
                                    technology that makes a meaningful impact on the world. Our vision is to democratize
                                    access to cutting-edge automation and intelligence, empowering businesses and
                ...
                <section
                    className="relative min-h-[400px] md:min-h-[500px] lg:min-h-[567px] flex items-end overflow-hidden relative">
                    {/* Background Image Placeholder */}
                    <Image className="absolute w-full h-full object-cover" src={PeopleBanner} alt="people banner"
                           width={1000} height={1000}/>

                    {/* Gradient Overlay */}
                    <div
                        className="absolute inset-0 bg-gradient-to-t from-[rgba(10,10,11,0.95)] via-[rgba(10,10,11,0.6)] to-[rgba(10,10,11,0.3)]"/>
                    ...
                    <div className="relative z-10 container pb-12 md:pb-16 lg:pb-[64px]">
                        <div className="flex flex-col lg:flex-row items-end gap-8 lg:gap-16">
                            ...
                            >
                                To revolutionize robotics and AI, we need exceptional talent. Based in Nagoya, our team
                                operates across multiple continents. With expertise spanning robotics, software
                ...
                <section className="py-12 md:py-20 lg:py-[100px]">
                    <div className="container">
                        <div className="flex flex-col lg:flex-row-reverse items-center gap-8 md:gap-12 lg:gap-16">
                            ...
                            >
                                <div
                                    className="relative w-full h-[300px] sm:h-[400px] lg:h-[500px] rounded-[16px] bg-gradient-to-br from-[#1a1a1b] to-[#0a0a0b] overflow-hidden shadow-xl">
                            ...
                            >
                                ...
                                <motion.p
                                    ...
                                    className="text-neutral-400 text-sm sm:text-base leading-relaxed"
                                >
                                    Through continuous research and development, we're pushing the boundaries of what's
                                    possible in robotics and AI, creating solutions that are not just technologically
                                    advanced, but also accessible, reliable, and built to last.
                                </motion.p>
                            </motion.div>
                        </div>
                    </div>
                                ...
                                >
                                    <Card className="bg-[#0a0a0b] p-0 border-0 rounded-[16px] overflow-hidden h-full">
                                        <CardContent className="p-0 relative">
                                            {/* Image Placeholder */}
                                            <div
                                                className="relative w-full h-[280px] sm:h-[300px] lg:h-[320px] bg-gradient-to-br from-[#2a2a2b] to-[#1a1a1b] overflow-hidden">
                                                <div
                                                    className="absolute inset-0 h-full flex items-center justify-center text-neutral-700 text-xs">
                                                ...
                                                <div
                                                    className="absolute bottom-0 left-0 right-0 h-[140px] bg-gradient-to-t from-[rgba(10,10,11,0.98)] via-[rgba(10,10,11,0.75)] to-transparent pointer-events-none"/>
                                            </div>
                ...
                {/* CTA Section */}
                <section
                    className="min-h-[400px] relative md:min-h-[500px] lg:min-h-[551px] flex items-center justify-center overflow-hidden">
                    {/* Background Image Placeholder */}
                    <Image src={Join} alt="join us" className="w-full h-full object-cover absolute" height={1000} width={1000}/>

                    {/* Gradient Overlays */}
                    <div
                        className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[rgb(10,10,11)]"/>
                    <div
                        className="absolute inset-0 bg-gradient-to-r from-[rgba(10,10,11,0.95)] via-[rgba(10,10,11,0.7)] to-[rgba(10,10,11,0.95)]"/>
                    ...
                    <div className="relative z-10 container px-4 sm:px-6 text-center">
                        ...
                        >
                            We're looking for talented individuals who are passionate about robotics, AI, and building
                            the future. Explore opportunities to work on cutting-edge technology.
                        </motion.p>
                        <motion.div
                            initial={{opacity: 0, y: 20}}
                            whileInView={{opacity: 1, y: 0}}
