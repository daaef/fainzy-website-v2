...
const blogPosts = [
    ...
    },
    {
        ...
        category: "Technology",
        title:
            "AI and Machine Learning: The Brain Behind Smart Delivery Robots",
        description:
    ...
    },
    {
        ...
        category: "Case Study",
        title:
            "Customer Success Story: How Restaurant Chain MiraX Increased Efficiency by 40%",
        description:
    ...
    },
    {
        ...
        category: "Technology",
        title:
            "The Sensor Technology That Makes Autonomous Navigation Possible",
        description:
    ...
    },
    {
        ...
        category: "Careers",
        title:
            "Building Tomorrow's Workforce: Careers in Robotics at Fainzy Technologies",
        description:
    ...
    },
    {
        ...
        title:
            "Sustainability in Robotics: How ZiBot Reduces Carbon Footprint",
        description:
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                        ...
                        <div className="flex flex-col justify-center p-6 md:p-10 space-y-6">
                            ...
                            <p className="text-neutral-400 max-w-prose">
                                ...
                                cutting-edge AI technology, advanced sensors, and autonomous navigation. Learn about the
                                innovative features that make ZiBot the most reliable delivery solution for hotels,
        ...
        <section className="py-12 md:py-20 lg:py-[100px]">
            <div className="container">
                <div className="bg-gradient-to-b py-20 from-[#0e0e0f] to-[#0a0a0b] rounded-xl p-8 text-center">
                    ...
                    <p className="text-neutral-400 mb-6">Stay updated with the latest news, insights, and innovations from Fainzy Technologies.</p>
                    ...
                    <p className="text-xs text-neutral-500 mt-4">By subscribing, you agree to our Privacy Policy and provide consent to receive updates from our company.</p>
                </div>
            </div>
        </section>
    );
