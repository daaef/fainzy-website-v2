        ...
        <section className="py-12 md:py-16">
          <div className="container">
            <p className="text-center text-neutral-400 max-w-3xl mx-auto">
              We&apos;re looking for talented, passionate individuals who want to make a real
              impact. Whether you&apos;re an engineer, designer, researcher, or operations
              specialist, there&apos;s a place for you here. Join our team of innovators working on
              cutting-edge projects that push the boundaries of what&apos;s possible.
            </p>
          </div>
        </section>
          ...
          <div className="container flex flex-col lg:flex-row items-center gap-8">
            <div className="flex-1">
              ...
              <p className="text-neutral-400">
                To accelerate the world&apos;s transition to sustainable automation through
                intelligent robotics and AI systems. We believe that by combining human creativity
                with machine precision, we can solve some of the world&apos;s most pressing
                challenges while creating meaningful work for our team members.
              </p>
            </div>
        ...
        <section className="relative min-h-[50vh] overflow-hidden">
          ...
          <div className="relative z-10 container py-20">
            <div className="max-w-2xl">
              ...
              <p className="text-neutral-400">
                Work in state-of-the-art facilities equipped with the latest technology, tools, and
                resources. Our labs and workspaces are designed to foster innovation and
                collaboration.
              </p>
            </div>
          </div>
          ...
          <div className="container grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-neutral-400 mb-6">
                ...
                support your health, growth, and well-being.
              </p>
        ...
        <section className="py-16 bg-[#0a0a0b]">
          <div className="container grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <p className="text-neutral-400">
                Work on projects that impact millions of users and transform entire industries. Our
                team is developing breakthrough technologies in autonomous systems, machine
                learning, and robotics that will shape the future of work and society.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="container grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-neutral-400">
                We invest heavily in our team&apos;s development through mentorship programs,
                workshops, conferences, and educational opportunities. Your growth is our priority,
                and we provide the resources and support you need to advance your career.
              </p>
            </div>
            <div className="rounded-[8px] overflow-hidden shadow-lg h-80">
              <Image
        ...
        <section className="py-16 bg-[#0a0a0b]">
          <div className="container text-center">
            ...
            <p className="text-neutral-400 max-w-2xl mx-auto mb-8">
              Explore our open positions and find the perfect role for you. We&apos;re always
        ...
        <section id="open-positions" className="py-16 bg-[#0a0a0b]">
          <div className="container">
            <div className="text-center mb-6">
              ...
              <p className="text-neutral-400">
                {jobs.length} positions available across multiple departments
              </p>
            </div>
