							...
							<div className="space-y-8">
								<div>
									...
									<p className="text-neutral-400 text-base md:text-lg max-w-[520px] leading-relaxed mb-6">
										Having a question about our robotics solutions or want to
									...
									<div className="space-y-6">
										...
										<div>
											...
											<p className="text-neutral-50 text-sm leading-relaxed">
												Incubation Facility, Nagoya University, Tsuji Nagata
												University Organization 1 Type-304, OTrauma 8s, Nagoya
												City, Japan, 464-8613
											</p>
										</div>
									</div>
