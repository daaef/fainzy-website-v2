...
export default function Home() {
  ...
  const products: ProductType[] = [
    ...
    },
    {
      ...
      id: "consultancy",
      description:
        "Expert robotics and AI consulting services to help transform your business. Our experienced team provides comprehensive solutions including autonomous driving systems, robot development, mobile and web application development, and AI applications using deep learning.",
      image: Consultancy,
      link: "/contact",
      features: [
        { title: "24/7 Operation", subtitle: "Always Available", icon: Clock },
