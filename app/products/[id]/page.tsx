...
export default function ProductPage() {
    ...
    const mainFeatures = [
        {
            ...
            description: "Robots don't need to sleep or rest like the clock. They can operate 24/7. This means users can order food at any time, including late-night cravings or early morning meals."
        },
        {
            id: 2,
            image: "https://images.unsplash.com/photo-1526378800651-c32d170fe6f8?w=1200&q=80",
            title: "All-Weather Operation",
            description: "All-weather capability means ZiBot operates consistently regardless of rain, snow, or extreme temperatures. While human drivers cancel deliveries due to weather, ZiBot keeps moving—delivering consistently regardless of conditions."
        },
        {
            id: 3,
            image: "https://images.unsplash.com/photo-1758989388630-d629d4ea9806?w=1200&q=80",
            title: "Zero Contact",
            description: "You can buy food from ZiBot without touching any buttons or making physical contact. Robots provide a perfect solution for contactless delivery, ensuring hygiene."
        },
    ];
    ...
    const sensingFeatures = [
        {
            ...
            description: "Robots are programmed to follow precise routes, delivering to customer addresses exactly where the orders need to go. This eliminates the possibility of missed deliveries or delivery during rush hours."
        },
        {
            id: 2,
            image: "https://images.unsplash.com/photo-1526378800651-c32d170fe6f8?w=1200&q=80",
            title: "Navigate Traffic",
            description: "Robots can navigate through traffic and congested areas faster than human delivery drivers, resulting in quicker delivery times. This ensures that customers receive their food promptly, especially during peak hours. Unlike human..."
        },
        {
            id: 3,
            image: "https://images.unsplash.com/photo-1758989388630-d629d4ea9806?w=1200&q=80",
            title: "Never Gets Tired",
            description: "Unlike human workers, robots don't get tired, distracted or affected by personal factors that typically impact human workers' productivity. They deliver consistent performance, leading to higher efficiency."
        },
    ];
    ...
    const durabilityCards = [
        {
            ...
            description: "ZiBot handles deliveries autonomously while your team focused on what matters—ensuring your customers receive what they expect, every time."
        },
        {
            id: 2,
            image: "https://images.unsplash.com/photo-1526378800651-c32d170fe6f8?w=600&q=80",
            title: "Rain, Snow, Heat—Doesn't Matter",
            description: "All-weather capability means ZiBot operates under any conditions. While human drivers cancel, ZiBot keeps moving. Your delivery arrives regardless of forecast."
        },
        {
            id: 3,
            image: "https://images.unsplash.com/photo-1758989388630-d629d4ea9806?w=600&q=80",
            title: "Curbs, Steps, Rough Pavement—Handled",
            description: "ZiBot handles tough urban surfaces. Curbs, cracks, steps, weather. It powers through what stops other order drivers and delivers even in street-level chaos."
        },
        {
            id: 4,
            image: "https://images.unsplash.com/photo-1688585931817-fdd211458b60?w=600&q=80",
            title: "Navigates Crowds Like a Local",
            description: "Sidewalk packed? Train station chaos? ZiBot moves through high-traffic sidewalks without slowing down or bumping anyone. Street-savvy by design."
        },
        {
            id: 5,
            image: "https://images.unsplash.com/photo-1629248242733-43d4013f33a1?w=600&q=80",
            title: "Secure by Design. Monitored 24/7.",
            description: "Real-time remote monitoring and autonomous data tracking provide constant fleet oversight. Nobody messes with ZiBot. Multi-layer security and tamper alerts keep people out."
        },
        {
            id: 6,
            image: "https://images.unsplash.com/photo-1526378800651-c32d170fe6f8?w=600&q=80",
            title: "Strict on precision",
            description: "GPS tracking and smart AI-routing guarantee flawless deliveries. Your order arrives exactly how it left—perfect temperature, secure handoffs, and pinpoint accuracy."
        },
    ];
    ...
    const safeFoodFeatures = [
        {
            ...
            description: "360° environmental sensing provides complete visibility with no blind spots. Every direction, pedestrian, and vehicle is detected and tracked in real-time."
        },
        {
            id: 2,
            image: "https://images.unsplash.com/photo-1526378800651-c32d170fe6f8?w=1200&q=80",
            title: "Navigate Around Barriers",
            description: "Obstacle avoidance technology navigates around barriers, construction zones, and unexpected obstacles automatically. Safe operation in any environment."
        },
        {
            id: 3,
            image: "https://images.unsplash.com/photo-1758989388630-d629d4ea9806?w=1200&q=80",
            title: "Absorbs Every Bump",
            description: "Advanced suspension system provides smooth ride over terrain. Protects cargo from shocks while navigating curbs, cracks, and uneven surfaces."
        },
    ];
    ...
    const everydaySolutionsCards = [
        {
            ...
            description: "Get it all, or 6 AM? Now done-delivery party or supplies? Fresh groceries after work."
        },
        {
            id: 2,
            image: "https://images.unsplash.com/photo-1526378800651-c32d170fe6f8?w=600&q=80",
            title: "Event Send. Child Awaited.",
            description: "Run out of supplies mid-event? Need last-minute supplies for a party? ZiBot delivers supplies without the panic."
        },
        {
            id: 3,
            image: "https://images.unsplash.com/photo-1758989388630-d629d4ea9806?w=600&q=80",
            title: "Medicine When You Need It Most",
            description: "Temperature-controlled transport keeps prescriptions safe. Discreet compartments ensure privacy. Urgent deliveries arrive when they're needed most."
        },
        {
            id: 4,
            image: "https://images.unsplash.com/photo-1688585931817-fdd211458b60?w=600&q=80",
            title: "Returns Without the Trip.",
            description: "Schedule pickup online or returns call-in retailers. Gather online shopping around the corner. ZiBot collects returns around local business places."
        },
        {
            id: 5,
            image: "https://images.unsplash.com/photo-1629248242733-43d4013f33a1?w=600&q=80",
            title: "Shop Local. Delivered Fast.",
            description: "Your neighborhood bakery delivers via ZiBot like major chains. The local shop street-level eCommerce with chains. ZiBot gives street-level businesses with chains delivery expertise."
        },
    ];
    ...
    const protectedPrivateCards = [
        {
            ...
            description: "Multi-layer access codes and sealed compartments keep orders private and secure until you unlock them."
        },
        {
            id: 2,
            image: "https://images.unsplash.com/photo-1629248242733-43d4013f33a1?w=600&q=80",
            title: "Tracked Every Step",
            description: "Real-time GPS, tamper alerts, and geostamped drop-off data keep you fully visibility from pickup to porch."
        },
        {
            id: 3,
            image: "https://images.unsplash.com/photo-1526378800651-c32d170fe6f8?w=600&q=80",
            title: "Temperature Perfect. Always.",
            description: "Active climate control and insulated compartments preserve meals and medicines at the right temperature."
        },
        {
            id: 4,
            image: "https://images.unsplash.com/photo-1688585931817-fdd211458b60?w=600&q=80",
            title: "Built With Backups",
            description: "Multiple sensors, safe-stop logic, and hardware failsafes prevent problems like."
        },
        {
            id: 5,
            image: "https://images.unsplash.com/photo-1629248242733-43d4013f33a1?w=600&q=80",
            title: "Your Data Stays Yours",
            description: "End-to-end encryption and minimal data retention protect your information and delivery details."
        },
        {
            id: 6,
            image: "https://images.unsplash.com/photo-1526378800651-c32d170fe6f8?w=600&q=80",
            title: "Monitor 24/7. Problems Solved Fast.",
            description: "Remote monitoring and fast-response tools resolve issues quickly so delivery never gets stuck."
        },
    ];
                ...
                items: [
                    {
                        ...
                        description: "ZiBot handles deliveries autonomously while your team focused on what matters."
                    },
                    {
                        id: 2,
                        image: "https://images.unsplash.com/photo-1526378800651-c32d170fe6f8?w=600&q=80",
                        title: "Live in 6 Steps. Delivering Today.",
                        description: "Launch your autonomous delivery fleet instantly—no setup or no hassles. Get started. No fuss, and start delivering."
                    },
                    {
                        id: 3,
                        image: "https://images.unsplash.com/photo-1758989388630-d629d4ea9806?w=600&q=80",
                        title: "Handle Peak Rushes Effortlessly",
                        description: "ZiBot adapts to any demand—whether 10 or 1,000 orders. It navigates traffic better, peak hours into profit while others falter."
                    },
                ],
            },
            {
                ...
                items: [
                    {
                        ...
                        description: "On-demand deliveries that fit your schedule — reliable, predictable service that frees you from errands and delays."
                    },
                    {
                        id: 2,
                        image: "https://images.unsplash.com/photo-1629248242733-43d4013f33a1?w=600&q=80",
                        title: "Temperature-Controlled. No Contact.",
                        description: "Temperature-controlled compartments, private tracking and clear ETAs keep orders fresh and exactly when they should."
                    },
                    {
                        id: 3,
                        image: "https://images.unsplash.com/photo-1526378800651-c32d170fe6f8?w=600&q=80",
                        title: "Tracked. Secure. Contactless.",
                        description: "App-controlled access, anti-theft tracking and fully-connected handoffs for secure, no-touch deliveries."
                    },
                ],
            },
        ],
    ...
    const pricingData = {
        ...
        description: "ZiBot doesn't just deliver. It transforms your operations, frees your staff, and cuts costs. All while delighting customers.",
        ...
        <div className="text-white font-[family-name:var(--font-inter)]">
            ...
            <section className="relative min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 py-12 sm:py-20">
                ...
                <div className="absolute inset-0 z-0">
                    ...
                    {/* Radial gradient overlay to blend with bg-[#0a0a0b] */}
                    <div
                        className="absolute inset-0"
                        style={{
                            background: 'linear-gradient(to bottom, rgba(10,10,11,.5) 0%, rgba(10,10,11,.6) 45%, rgba(10,10,11,1) 100%)'
                        }}
                    ></div>
                </div>
                ...
                >
                    ...
                    >
                        ANYTHING - ANYTIME - ANYWHERE <br />DELIVERY
                    </motion.p>
                    ...
                    >
                        ...
                        <Button
                            className="bg-white text-black hover:bg-gray-200 px-6 sm:px-8 py-4 sm:py-6 text-xs sm:text-sm font-semibold rounded-md">
                            GET STARTED
                        </Button>
                        <button className="p-2.5 sm:p-3 rounded-full border border-white/30 hover:bg-white/10 transition-colors">
            ...
            <section className="px-4 sm:px-6 py-12 sm:py-20">
                ...
                >
                    ...
                    <p className="text-sm sm:text-base text-gray-400 mb-8 sm:mb-12">
                        Traffic, rain, curbs, or crowds – ZiBot sees, senses, and adapts on its own, keeping deliveries
                        on track
                    </p>
            ...
            <section className="px-4 sm:px-6 py-12 sm:py-20">
                ...
                >
                    ...
                    <p className="text-sm sm:text-base text-gray-400 mb-8 sm:mb-12">
                        Food safety certified with a hygienic delivery process. In situations where contactless delivery
                        is preferred, robots provide an ideal solution without direct human contact.
                    </p>
            ...
            <section className="px-4 sm:px-6 py-12 sm:py-20">
                <div className="container">
                    <BenefitGrid
                        title={autonomyBenefits.title}
                        sections={autonomyBenefits.sections}
                    />
                </div>
            </section>
            ...
            <section className="px-4 sm:px-6 py-12 sm:py-20">
                ...
                >
                    ...
                    <Button
                        className="bg-white text-black hover:bg-gray-200 px-6 sm:px-8 py-3 sm:py-4 text-xs sm:text-sm font-semibold rounded-md">
                        Get Started
                    </Button>
                </motion.div>
            </section>
            ...
            <section className="px-4 sm:px-6 py-12 sm:py-20">
                <div className="container">
                    <RobotTopViewGrid
                        robotImage="/products/navigate.png"
                        title="Launch in 6 Simple Steps"
                ...
                <div className="container min-h-[50vh] sm:min-h-[70vh] relative">
                    ...
                    <div className="relative inset-0 z-0">
                        ...
                        <div
                            className="absolute inset-0"
                            style={{
                                background: 'radial-gradient(ellipse at center, transparent 0%, rgba(10,10,11,0.6) 30%, rgba(10,10,11,0.8) 40%, rgba(10,10,11,1) 65%, rgba(10,10,11,1) 75%, rgba(10,10,11,1) 100%)'
                            }}
                        ></div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[.6fr_1fr] items-center justify-between gap-8 sm:gap-12">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="space-y-6 sm:space-y-8">
                                <div>
                                    <h3 className="text-base sm:text-lg font-bold text-white mb-3 sm:mb-4">Performance</h3>
                                ...
                                <div>
                                    <h3 className="text-base sm:text-lg font-bold text-white mb-3 sm:mb-4">Dimensions</h3>
                                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 sm:gap-6 text-xs sm:text-sm">
                                        <div>
                                ...
                                <div>
                                    <h3 className="text-base sm:text-lg font-bold text-white mb-3 sm:mb-4">Battery & Charging</h3>
                                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 sm:gap-6 text-xs sm:text-sm">
                                        <div>
                                ...
                                <div>
                                    <h3 className="text-base sm:text-lg font-bold text-white mb-3 sm:mb-4">Control & Interface</h3>
                                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 sm:gap-6 text-xs sm:text-sm">
                                        <div>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-8 sm:gap-12">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            ...
                            <div className="flex items-center justify-center md:justify-start gap-3 sm:gap-4">
                                <Button
                                    className="bg-white text-black hover:bg-gray-200 px-6 sm:px-8 py-2 sm:py-2.5 text-xs sm:text-sm font-semibold rounded-md">
                                    GET STARTED
                                </Button>
                                <button
                                    className="w-8 h-8 sm:w-9 sm:h-9 rounded-full border border-white/20 hover:bg-white/10 transition-colors flex items-center justify-center">
