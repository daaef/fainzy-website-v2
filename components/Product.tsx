...
export default function Product({ title, description, image, features, reverse = false }: ProductType) {
    return (
            ...
            >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-[24px] w-full pt-6 md:pt-8 lg:pt-[33px] border-t border-[rgba(255,255,255,0.08)]">
                    {features?.map((feature, i: number) => (
                        ...
                        >
                            {feature.icon && (
                                <feature.icon className="w-5 h-5 md:w-6 md:h-6 text-white mb-2" />
                            )}
