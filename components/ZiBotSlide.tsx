...
export default function ZiBotSlide({ title = "ZiBot", subtitle = "Anything Anytime Anywhere", cursiveText = "Delivery", imageUrl = "/slides/zibot.png", ctaText = "Learn More", ctaLink = "/products/zibot" }: SlideProps) {
  return (
    <div className="p-1">
      <div className="relative h-full">
        ...
        >
          <h2 className="font-bold text-center font-zibot">{title}</h2>
        </motion.div>
        <motion.div
