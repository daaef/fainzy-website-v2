...
export default function CardCarousel({
    ...
    const basisClass = cardsPerView === 4 ? "md:basis-1/2 lg:basis-1/3 xl:basis-1/4" :
                       cardsPerView === 5 ? "md:basis-1/2 lg:basis-1/3 xl:basis-1/5" :
                       cardsPerView === 6 ? "basis-1/2 md:basis-1/3 lg:basis-1/4 xl:basis-1/6" :
                ...
                >
                    ...
                    {navigationPosition === "side" ? (
                        ...
                        <div className="absolute top-0 right-0 flex gap-2">
                            <CarouselPrevious className="relative left-0 top-0 translate-y-0 text-white border-white hover:bg-white hover:text-black" />
                            <CarouselNext className="relative right-0 top-0 translate-y-0 text-white border-white hover:bg-white hover:text-black" />
                        </div>
                    )}
                </Carousel>
            </div>
