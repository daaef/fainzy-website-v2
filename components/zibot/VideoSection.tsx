...
export default function VideoSection({
    ...
    const heightClass =
        height === "small" ? "h-[300px] md:h-[400px]" :
        height === "large" ? "h-[400px] md:h-[500px]" :
        "h-[300px] md:h-[400px] lg:h-[500px]";

    const overlayPositionClass =
        overlayPosition === "center" ? "absolute inset-0 flex items-center justify-center" :
        overlayPosition === "top-left" ? "absolute top-8 left-8" :
